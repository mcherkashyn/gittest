...
var ScrollAnimation = (function (_Component) {
    ...
    _createClass(ScrollAnimation, [{
        ...
        value: function isVisible() {
            var viewBottom = ScrollAnimation.posTop() + window.innerHeight;
            var viewTop = ScrollAnimation.posTop();
            var offset = this.props.offset;
            var elementBottom = this.state.elementBottom;
            var elementTop = this.state.elementTop;
            var middleOfView = ScrollAnimation.posTop() + window.innerHeight / 2;
